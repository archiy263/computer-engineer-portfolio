  ...
  const skillGroups = [
    {
      ...
      summary: "Core languages for logic and scripting.",
      items: ["Python", "SQL", "JavaScript", "C++"],
    },
    {
      title: "Frontend",
      summary: "User interfaces and client-side development.",
      items: ["React.js", "HTML5", "CSS3"],
    },
    {
      title: "Backend",
      summary: "Server-side logic and APIs.",
      items: ["FastAPI", "Django", "Flask", "Node.js", "Express.js"],
    },
    {
      title: "Databases",
    ...
    {
      title: "AI/ML",
      summary: "Intelligent systems and tools.",
      items: ["Generative AI", "NLP", "Speech Recognition", "Vertex AI"],
    },
    {
      title: "Cloud",
      summary: "Infrastructure and deployment.",
      items: ["Google Cloud", "Cloud Storage"],
    },
    {
      title: "Developer Tools",
      summary: "Workflows and environments.",
      items: ["Git & GitHub", "Docker", "Postman", "VS Code"],
    },
    {
      title: "Concepts",
      summary: "Networking and software engineering.",
      items: ["REST APIs", "TCP/IP Basics", "JWT", "Agile & SDLC"],
    },
  ];
