      ...
      <div className="section">
        <div className="mb-20 text-center">
          ...
          <p className="mx-auto mt-8 max-w-3xl px-2 text-base font-light leading-relaxed text-(--muted) sm:text-xl">
            A selection of projects that showcase my experience in building scalable backend systems, APIs, and AI integrations.
          </p>
        </div>
        ...
        >
          <a
            href="https://github.com/archiy263?tab=repositories"
            target="_blank"
