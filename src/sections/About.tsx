    ...
    >
      ...
      <div className="grid grid-cols-2 gap-3 md:grid-cols-3 md:grid-rows-[9rem_auto_9rem]">
        <article className="md:hidden col-span-1 row-span-1 rounded-2xl border border-(--card-border) bg-linear-to-br from-(--card) to-(--card-border) p-6">
          ...
          <h3 className="mt-2 text-3xl font-black leading-[1.05]">ARCHI YADAV</h3>
        ...
        <article className="hidden md:flex col-span-1 row-span-1 rounded-2xl border border-(--card-border) bg-linear-to-br from-(--card) to-(--card-border) p-7">
          <div className="flex w-full flex-col justify-center text-center">
            <p className="text-xs uppercase tracking-[0.2em] text-violet-300">Profile</p>
            <h3 className="mt-2 text-4xl font-black leading-[1.05]">ARCHI YADAV</h3>
        ...
        >
          ...
          <p className="mt-2 text-xs leading-relaxed text-(--muted) sm:text-sm">
            B.E. in Computer Engineering from Sigma Institute of Engineering (2022–2026). CGPA: 8.94/10.
          </p>
        </article>
          ...
          <div className="mt-3 space-y-4">
            <div>
              ...
              <ul className="mt-1.5 space-y-1 text-[11px] leading-relaxed text-(--muted)">
                ...
                <li>• Debugged Python applications and performed Postman API testing.</li>
              </ul>
            </div>
            <div>
              <h4 className="text-xs font-semibold text-(--foreground)">Backend Intern @ BrainyBeam InfoTech</h4>
              <ul className="mt-1.5 space-y-1 text-[11px] leading-relaxed text-(--muted)">
                <li>• Built and maintained Python backend applications and APIs.</li>
                <li>• Implemented authentication, DB operations, and third-party APIs.</li>
              </ul>
            </div>
          </div>
        </article>
        ...
        >
          ...
          <div className="absolute bottom-0 left-0 w-full p-3">
            <p className="text-xl font-bold leading-none">Vadodara</p>
            <p className="text-[11px] text-(--muted)">IST</p>
          </div>
        </article>
        ...
        >
          ...
          <p className="mt-2 text-xs leading-relaxed text-(--muted) sm:text-sm">
            Dedicated to solving complex problems, building scalable backend systems, and continuously learning new technologies.
          </p>
